...
function HomePage() {
  ...
  const logSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    navigate("/output", { state: { PastedInput: pastedInput }});
    setPastedInput("");
  }
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col justify-center space-y-3">
        ...
        <div className="flex flex-col items-center">
          <form className="flex flex-col items-center" method="post" onSubmit={logSubmit}>
            <textarea className="resize-none bg-zinc-200" value={pastedInput} onChange={ e => handleChange(e)} rows={(inputType == "URL" ? 1 : 4)} cols={49}/>
      ...
      <div className="mx-auto p-4 bg-lime-500 rounded-lg m-4">Logo</div>
    </div>
  );
}
